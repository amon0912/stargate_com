<header class="container-fluid" style="border-left:8px solid #FF8103;">
    <div class="row pt-1 pb-3">
        ...
        <!-- <div class="d-flex">
            <div class="btn rounded-circle border " style="height: 40px; width:40px; background:#fff; z-index:2">
            </div>

            <div>
                <h3 class=" kColor-text shadow-sm" style="font-size:17px; position:relative; z-index:1; top:5px; ">
                    Stargate Communication
                </h3>
                <div class="border border-white"
                    style="height:2px; z-index:0; width:104%; position:relative; left:-5px; top:-5px">
                </div>
            </div>
        </div> -->
