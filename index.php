...
<head>
    ...
    <script data-ad-client="ca-pub-5480671124829646" async
    ...
    <meta name="keywords"
        content="communication, marketing, creation de site internet, creation d'application mobile, community management, referencement seo">
...
<body>
    ...
    <?php
    if ($p == 'inscription' || $p == 'modifier-info' || $p == 'modifier-mot-de-passe') {
        echo ' <script src="assets/js/' . $p . '.js"></script>';
    }
    ?>
